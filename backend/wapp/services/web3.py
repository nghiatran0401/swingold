...
with open(os.path.join(os.path.dirname(__file__), "../../dapp/contracts/TradeManagerABI.json"), "r") as f:
    trade_abi = json.load(f)
with open(os.path.join(os.path.dirname(__file__), "../../dapp/contracts/TokenABI.json"), "r") as f:
