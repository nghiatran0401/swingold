...
function Items ({ logout }) {
  ...
  const [_walletStatus, _setWalletStatus] = useState('');
  ...
  const _renderWalletSection = () => (
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', my: 4 }}>
      ...
      >
        ...
        <Box>
          <Typography sx={{ fontFamily: 'Poppins', color: '#888' }} variant='subtitle2'>
            Wallet
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Typography sx={{ fontFamily: 'Poppins', fontWeight: 700 }} variant='h6'>
              {`${walletAddress?.slice(0, 6)}...${walletAddress?.slice(-4)}`}
            </Typography>
          </Box>
          <Typography
            sx={{ fontFamily: 'Poppins', color: '#ff001e', fontWeight: 600, mt: 0.5 }}
            variant='body2'
          >
                  ...
                  <Box
                    sx={{
                      ...
                      '&::before': {
                        ...
                        bottom: 0,
                        background:
                          'linear-gradient(45deg, rgba(255, 0, 30, 0.1), rgba(212, 0, 26, 0.1))',
                        zIndex: 1,
                      },
                    }}
                  >
          ...
          {selectedItem && (
            <>
              ...
              >
                ...
                >
                  <CheckCircleIcon
                    sx={{ color: '#4caf50', fontSize: { xs: '1.5rem', sm: '1.8rem', md: '2rem' } }}
                  />
                  <Typography
                    sx={{
                      color: '#2A2828',
                ...
                {txStatus && (
                  <Alert
                    severity={txStatus.startsWith('Transaction failed') ? 'error' : 'info'}
                    sx={{ mt: 2, mb: 2 }}
                  >
                    {txStatus}
                  </Alert>
