  ...
  useEffect(() => {
    ...
    if (searchInput.trim()) {
      filtered = filtered.filter(
        event =>
          (event.name && event.name.toLowerCase().includes(searchInput.toLowerCase())) ||
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 2 }}>
                {months.map(month => (
                  <Chip
                    ...
                    sx={{
                      backgroundColor:
                        selectedMonth === month ? '#ff001e' : 'rgba(255,255,255,0.8)',
                      ...
                      '&:hover': {
                        backgroundColor:
                          selectedMonth === month ? '#d4001a' : 'rgba(255,255,255,0.9)',
                          ...
                          sx={{
                            background:
                              event.price === 0
                                ...
                                : 'linear-gradient(45deg, #ff001e, #d4001a)',
                            color: '#ffffff',
                            fontFamily: 'Poppins',
                            fontWeight: '700',
                            fontSize: '0.9rem',
                  ...
                  <Chip
                    label={
                      selectedEvent.price === 0
                        ? '🎉 Free'
                        : `${selectedEvent.price.toFixed(2)} GOLD`
                    }
                    sx={{
                      background:
                        selectedEvent.price === 0
